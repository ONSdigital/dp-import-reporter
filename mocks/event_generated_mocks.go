...
// DatasetAPICliMock is a mock implementation of event.DatasetAPICli.
//
//     func TestSomethingThatUsesDatasetAPICli(t *testing.T) {
//
//         // make and configure a mocked event.DatasetAPICli
...
//         }
//
//         // use mockedDatasetAPICli in code that requires event.DatasetAPICli
...
// CacheMock is a mock implementation of event.Cache.
//
//     func TestSomethingThatUsesCache(t *testing.T) {
//
//         // make and configure a mocked event.Cache
...
//         }
//
//         // use mockedCache in code that requires event.Cache
//         // and then make assertions.
//
//     }
...
// EventHandlerMock is a mock implementation of event.EventHandler.
//
//     func TestSomethingThatUsesEventHandler(t *testing.T) {
//
//         // make and configure a mocked event.EventHandler
...
//         }
//
//         // use mockedEventHandler in code that requires event.EventHandler
//         // and then make assertions.
//
//     }
